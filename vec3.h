...
public:
	...
	inline vec3 operator/=(float n) { float s = 1.0 / n; e[0] *= s; e[1] *= s; e[2] *= s; return *this; }

	inline float length() const { return sqrt(e[0] * e[0] + e[1] * e[1] + e[2] * e[2]); }
	inline float squared_length() const { return e[0] * e[0] + e[1] * e[1] + e[2] * e[2]; }
	inline vec3 normalize() const { float t = length(); return vec3(e[0] / t, e[1] / t, e[2] / t); }
	float e[3];
};
...
inline vec3 operator*(const float t, const vec3 &v1) { return vec3(v1.e[0] * t, v1.e[1] * t, v1.e[2] * t); }
inline vec3 operator/(const vec3 &v1, const float t) { return vec3(v1.e[0] / t, v1.e[1] / t, v1.e[2] / t); }
